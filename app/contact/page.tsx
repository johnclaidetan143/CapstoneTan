  ...
  return (
    <>
      ...
      <main className="min-h-screen flex items-center justify-center px-4 py-10"
        ...
        {/* Centered chat card */}
        <div className="w-full max-w-[480px] flex flex-col rounded-3xl overflow-hidden shadow-2xl"
          style={{ height: 620 }}>
          ...
          <div className="flex items-center gap-3 px-5 py-4"
            ...
            <div className="relative flex-shrink-0">
              ...
              />
              {/* Fallback avatar */}
              <div className="w-12 h-12 rounded-full bg-white/30 items-center justify-center text-xl hidden"
                style={{ display: "none" }}>
                🌸
              </div>
              {/* Green online dot */}
                  ...
                  <div key={msg.id}>
                    {showDate && (
                      <div className="flex justify-center my-3">
                        <span className="text-[11px] text-gray-400 px-3 py-1 rounded-full"
                          style={{ background: "#fce4ec" }}>
                    ...
                    <div className={`flex items-end gap-2 mb-0.5 ${isUser ? "flex-row-reverse" : "flex-row"}`}>
                      ...
                      {!isUser && (
                        <div className={`w-7 h-7 rounded-full flex-shrink-0 overflow-hidden border border-pink-200 ${showAvatar ? "visible" : "invisible"}`}>
                          ...
                          />
                          <div className="w-full h-full bg-pink-200 items-center justify-center text-xs hidden"
          ...
          {/* ── Input area ── */}
          <div className="px-4 py-3 flex items-center gap-2 border-t border-pink-100"
